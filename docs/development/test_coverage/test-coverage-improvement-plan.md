...
### Current State (post Phase 6, March 2026)

| Metric                       | Value                                        |
| ---------------------------- | -------------------------------------------- |
| Test Framework               | Vitest 4.1.2 + jsdom                         |
| Test Files                   | 99 total                                     |
| Passing Tests                | 701 (100%)                                   |
| Failing Tests                | 0 (0%)                                       |
| Line Coverage (global)       | 46.20%                                       |
| Branch Coverage (global)     | 35.96%                                       |
| Function Coverage (global)   | 40.00%                                       |
...
Current thresholds (2026-03-30, post Phase 6): `lines: 39`, `branches: 32`, `functions: 33`.
...
### Phase 7: Article List Stability (Upcoming)

**Goal:** Strengthen the largest and most complex view in the plugin.

- **Target:** [article-list.ts](src/views/article-list.ts)
| Metric | Initial | Goal | Status |
| :--- | :--- | :--- | :--- |
| Lines | 10.24% | ≥ 30% | 🟦 Pending |
| Branches | 11.01% | ≥ 25% | 🟦 Pending |

- **Strategy Execution:**
    - Test `ArticleList` constructor and layout initialization.
    - Test article rendering and interaction (click to open).
    - Test filter menu orchestration.

### Phase 8: Web Viewer Integration (Upcoming)

**Goal:** Secure the external web view integration logic.

- **Target:** [web-viewer-integration.ts](src/services/web-viewer-integration.ts)
| Metric | Initial | Goal | Status |
| :--- | :--- | :--- | :--- |
| Lines | 0.28% | ≥ 60% | 🟦 Pending |
| Branches | 0.00% | ≥ 50% | 🟦 Pending |

_Last updated: 2026-03-30 (Post Phase 6 Consolidation)_
