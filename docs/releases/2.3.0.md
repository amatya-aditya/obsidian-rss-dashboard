...
- Added a user-facing setup and FAQ guide for storage workflows: [docs/storage-vault-shards-guide.md](../storage-vault-shards-guide.md).
...
- See [docs/plugin-scorecard.md](../plugin-scorecard.md), [docs/development/compliance-patterns.md](../development/compliance-patterns.md), and [docs/development/test-lint-backlog-tracker.md](../development/test-lint-backlog-tracker.md) for implementation and audit details.
