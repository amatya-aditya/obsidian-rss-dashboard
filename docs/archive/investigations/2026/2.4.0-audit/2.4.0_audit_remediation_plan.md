...
**Goal:** Every remaining declaration is either **removed** or **justified** with inline `/* audit-ok: … */` per [`CONTRIBUTING.md`](CONTRIBUTING.md) and [2.3.0 CSS templates](../2.3.0-audit/css-refactor-prompt-template.md).
