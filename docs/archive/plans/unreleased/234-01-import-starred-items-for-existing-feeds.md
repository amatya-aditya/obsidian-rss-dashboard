...
Items whose feed does not yet exist locally were excluded from this ticket's import; that gap is closed by [234-02](234-02-auto-create-missing-source-feeds.md). Surfacing entries that can never be imported (no source feed, no article URL) was completed in [234-03](234-03-surface-unimportable-entries.md), label-to-tag mapping was completed in [234-04](234-04-map-labels-to-tags.md), idempotent re-import was completed in [234-05](234-05-idempotent-reimport-dedup-merge.md), and opt-in full-content fetch was completed in [234-06](234-06-opt-in-full-content-fetch.md).
