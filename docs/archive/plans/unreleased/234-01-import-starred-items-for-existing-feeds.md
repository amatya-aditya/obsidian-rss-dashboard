...
Items whose feed does not yet exist locally are excluded from this ticket's import (deferred to [234-02](../../../plans/234-02-auto-create-missing-source-feeds.md)); no tag mapping (deferred to [234-04](../../../plans/234-04-map-labels-to-tags.md)) and no full-content fetch (deferred to [234-06](../../../plans/234-06-opt-in-full-content-fetch.md)) happen yet.
...
- No re-import dedup: selected items are appended to the target feed's `items` array unconditionally (this ticket assumes a clean one-time import per its explicit out-of-scope list; dedup/merge is 234-05).
