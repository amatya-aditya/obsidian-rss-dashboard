---
**Archived:** 2026-09-22  
**Reason:** README & Documentation Restructure — CONTRIBUTING.md rewritten as contributor portal (Before You Start → Dev Setup → Workflows → Testing → Code Quality → PRs → Branching detail → Release)  
**Replacement:** [CONTRIBUTING.md](../../../CONTRIBUTING.md)  
**Status:** Historical reference only; not authoritative  
---
