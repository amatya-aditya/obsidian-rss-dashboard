...
| ------------------------------------- | -------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Done locally; awaiting release/rescan | Missing contributing guide                                                 | Remediated in the current source: the root guide is now tracked as`CONTRIBUTING.md`(previous: CONTRIBUTING.MD), the conventional case likely required by a case-sensitive scorecard check. The captured 2.5.0 listing remains historical evidence until a new release is scanned.                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | Documentation/repository-metadata remediation complete locally. Verify repository links and the published 2.6.0 listing/community rescan. No runtime risk.                                                                                                                                                                                                                                                                                                                                                          |
| Deferred. See link in comments.       | Clipboard access disclosure                                                | Genuine, intentional runtime capability. Current code has no programmatic clipboard read; native paste remains user-mediated. Writes support three settings-export copy buttons, article/feed URL context-menu actions, copying a local-storage address, Reader copy with LaTeX source preservation, and a YouTube embed`clipboard-write` permission. The [clipboard removal assessment](development/clipboard-removal-assessment.md) itemizes each path and its removal impact. Complete removal is feasible without breaking feed management, fetching, file-based import, or download exports, but would remove these sharing/convenience workflows and degrade Reader math copying. It is therefore not a proportionate response to a disclosure finding. | Retain the capability and make the disclosure unambiguous. Verify the scorecard's supported repository or listing disclosure channel, then submit the exact user-initiated/write-only scope and sensitive-clipboard caveat. Separately assess whether the YouTube iframe permission is needed. Validate settings exports, URL copying, local-storage-address copying, Reader math copy, YouTube playback, and community rescan. Privacy-review risk; no core-feature regression expected from disclosure-only work. |
| Done locally; awaiting release/rescan | Unnecessary assertion in`src/utils/settings-loader.ts`                     | Remediated in current source: a typed record copy is migrated and assigned back to the display settings, avoiding the invalid assertion while preserving the migration result. The captured 2.5.0 location remains historical evidence.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Focused settings-loader migration tests, strict ESLint, platform check, and build pass locally. Verify in the next release build and community rescan. Low behavioral risk.                                                                                                                                                                                                                                                                                                                                         |
| Done locally; awaiting release/rescan | Three unused destructured values in`src/services/import-export-service.ts` | Remediated in current source: a typed settings copy explicitly removes feeds, folders, and available tags before serializing, preserving the intentional export contract. The captured 2.5.0 locations remain historical evidence.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | Focused import/export tests, strict ESLint, platform check, and build pass locally. Verify in the next release build and community rescan. Low data-export compatibility risk.                                                                                                                                                                                                                                                                                                                                      |
| Done locally; awaiting release/rescan | 12`css-scrollbar` compatibility warnings                                   | Remediated in the captured source scope: the custom CSS Scrollbars L4 and WebKit styling in`src/styles/sidebar.css` and `src/styles/modals.css` has been removed, along with the sidebar preference that hid its scrollbar. Native overflow and native Obsidian scrollbars remain. The captured `styles.css:1` references are historical minified-bundle offsets; the 2.6.0 release artifact must be regenerated from this source. Other, later-introduced scrollbar styling outside these 12 captured findings remains separately out of scope.                                                                                                                                                                                                              | Run CSS scope/`!important` checks, focused sidebar-settings coverage, TypeScript/platform checks, a full build, and manual desktop/mobile sidebar and modal scrolling on the supported Obsidian floor. Confirm the release artifact and community rescan; do not treat the public Caution rating or all reported items as resolved before that rescan. Medium UX risk.                                                                                                                                              |
| Done locally; awaiting release/rescan | Five global`document` uses in `test_files/unit/test-dom-polyfills.ts`      | Remediated in the current jsdom-only polyfills: initialization uses `window.document`, and element helper fallbacks now prefer the owning document, then the configured active document. This remains test-only code and does not ship in the plugin runtime.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | A focused regression test verifies that the fallback creates a child in the active document. Focused lint and polyfill tests, the full unit suite, and the complete build pass locally. Verify in the next release build and community rescan. Low runtime risk; moderate test-harness regression risk.                                                                                                                                                                                                            |
...
The two production TypeScript cleanups above are complete locally; they remain
independent of the release/rescan follow-up for the public scorecard.
...
the contributing-guide and clipboard disclosures; (2) manually verify the
native scrollbar change and release bundle; (3) optionally align test
polyfills; (4) cut the 2.6.0 candidate, rerun repository gates, and
request/review the community rescan. Do not mark the Caution rating or all
captured findings resolved before that rescan.
