...
// Define interface for the internal method we're testing
interface SidebarWithScroll {
  addHorizontalScrollBehavior(el: HTMLElement): void;
}
...
describe("Sidebar Horizontal Scrolling", () => {
  ...
  beforeEach(() => {
    ...
    const addHorizontalScrollBehavior = (
      Sidebar.prototype as unknown as SidebarWithScroll
    )["addHorizontalScrollBehavior"];
  ...
  it("should support mouse drag scrolling", () => {
    ...
    Object.defineProperty(mouseMoveLarge, "preventDefault", {
      value: preventDefault,
    });
