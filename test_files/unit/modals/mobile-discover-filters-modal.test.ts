...
function setLastDiscoverSidebarInstance(instance: MockSidebar): void {
  lastDiscoverSidebarInstance = instance;
}
...
vi.mock("../../../src/components/discover-sidebar", () => {
  class DiscoverSidebar {
    ...
    constructor(
      ...
      setLastDiscoverSidebarInstance(this);
    }
  ...
  it("renders the discover sidebar and closes via callback", async () => {
    ...
    const modal = new MobileDiscoverFiltersModal(
      ...
      plugin as unknown as import("../../../main").default,
      {
        ...
        tags: [],
        tagMode: "any",
      } as unknown as import("../../../src/types/discover-types").DiscoverFilters,
      [],
      "types",
      onFilterChange,
    );
