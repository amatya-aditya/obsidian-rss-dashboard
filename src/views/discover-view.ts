...
export class DiscoverView extends ItemView {
  ...
  // Smallweb state
  private currentMode: "discover" | "smallweb" = "discover";
  ...
  render(): void {
    ...
    if (this.currentMode === "smallweb") {
      this.renderSmallwebLayout(container);
      return;
    }
  ...
  // ========================================
  // Smallweb Mode Methods
  // ========================================

  public switchToSmallweb(): void {
    this.currentMode = "smallweb";
    void this.fetchSmallwebFeed();
  }

  public switchToDiscover(): void {
  ...
  private renderSmallwebLayout(container: HTMLElement): void {
    container.empty();
  ...
  private renderSmallwebCard(
    ...
    if (isSubscribed) {
      ...
      followBtn.addEventListener("click", () => {
        void this.handleSmallwebSubscribe(entry, followBtn);
      });
    }
  }
  ...
  private async handleSmallwebSubscribe(
    ...
    try {
      ...
      if (isSubscribed) {
        ...
        buttonEl.className = "rss-smallweb-following-btn";
        return;
      }
      ...
      buttonEl.addClass("rss-smallweb-error-btn");

      setTimeout(() => {
        buttonEl.textContent = originalText;
        buttonEl.removeClass("rss-smallweb-error-btn");
      }, 2000);
    }
  }
