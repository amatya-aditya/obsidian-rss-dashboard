...
- Fixed configured backups being skipped for Shard storage v2, including user preferences when no legacy export file exists, and made backups complete after settings are saved instead of relying solely on plugin shutdown. [GH Issue #320](https://github.com/amatya-aditya/obsidian-rss-dashboard/issues/320)
