...
- Fixed changing the storage folder leaving the old folder behind, empty. The old folder, and any parent folder the move leaves empty, is now removed; a folder that still holds anything else, such as `user-state.json` or your own files, is kept.
