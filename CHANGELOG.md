...
- Added a paged podcast playlist that renders a five-episode window around the active episode, with order-relative browsing controls and a return-to-current action for large feeds. [GH Issue #183](https://github.com/amatya-aditya/obsidian-rss-dashboard/issues/183)
