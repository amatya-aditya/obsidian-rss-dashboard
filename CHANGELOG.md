...
- Hardened the GitHub release workflow by separating read-only build validation from privileged publication and provenance, pinning workflow Actions to reviewed commits, and attesting `manifest.json` alongside the plugin bundle.
